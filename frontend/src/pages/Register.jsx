...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#FAFAF8] via-white to-saffron-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-800 flex items-center justify-center px-4 py-10">
      {/* Floating shapes */}
      <div className="absolute top-20 right-10 w-32 h-32 rounded-full bg-saffron-400/20 dark:bg-saffron-500/20 blur-3xl animate-float" />
      <div className="absolute bottom-40 left-10 w-40 h-40 rounded-full bg-turmeric-400/20 dark:bg-turmeric-500/20 blur-3xl animate-float-reverse" />
        ...
        <div className="glass-card dark:bg-gray-800/80 dark:border-gray-700 rounded-3xl p-8 shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3.5 rounded-xl font-semibold text-white bg-gradient-to-r from-saffron-500 to-turmeric-500 shadow-lg shadow-saffron-200 hover:shadow-xl hover:scale-[1.02] transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:scale-100 mt-2"
            >
              {isLoading ? (
